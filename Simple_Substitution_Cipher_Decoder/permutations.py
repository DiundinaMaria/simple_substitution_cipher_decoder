...
def get_all_permutations_for_sets_with_known(letters_sets, known_letters):
    ...
    где есть пересечения ключ-значение с известными парами букв +
    добавляем в ключ известные пары если они отсутствуют """
...
def try_permutations_for_sets(cipher_text, set_string, known_letters):
    ...
    шифробуквы - расшифровки, из которых собираются все возможные пары ключей и значений.
